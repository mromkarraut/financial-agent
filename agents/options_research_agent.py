...
def _web_debit_calculator(s: dict, price: float) -> str:
    ...
    return (
        ...
        f' data-exp="{s["exp"]}">'
        f'<div class="hc-section-header">💲 Debit Calculator — adjust entry price &amp; contracts</div>'
        ...
        f'</div>'
        f'<div class="calc-controls">'
        f'<span class="calc-label">Contracts</span>'
        f'<input type="range" class="calc-slider calc-qty-slider"'
        f' min="1" max="20" step="1" value="1">'
        f'<input type="number" class="calc-input calc-qty-input"'
        f' min="1" max="100" step="1" value="1">'
        f'<span class="calc-orig">× 100 shares / contract</span>'
        f'</div>'
